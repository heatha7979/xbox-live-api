...
//void XSAPI_API xbl_signin_silently_complete(
//    _In_ uint64 returnCode,
//    _In_ void* context
//    )
//{
//    int val = static_cast<int>(reinterpret_cast<size_t>(context));
//}

void Game::SignInSilently()
{

    //xbl_thread_set_thread_ideal_processor(1, 1);
    //xbl_thread_set_thread_pool_num_threads(0);

    //xbl_signin_silently((void*)1, xbl_signin_silently_complete);

    std::weak_ptr<Game> thisWeakPtr = shared_from_this();
    xbl_signin_silently((void*)1, [](_In_ uint64 returnCode, _In_ void* context)
    {
        //std::shared_ptr<Game> pThis(thisWeakPtr.lock());
        //if (pThis == nullptr)
        //{
        ...
        //if (!t.err())
        //{
        //    xbox::services::system::sign_in_result result;
        //    pThis->HandleSignInResult(result);
        //}
        //else
        //{
    ...
    //bool isPending = xbl_thread_is_pending_async_op();
